-- TurboAgenda - Agenda day overrides
-- Adds per-business closed days and makes public availability respect them.
...
create index if not exists idx_business_day_overrides_business_date
  on public.business_day_overrides(business_id, date);

drop policy if exists "business_day_overrides_owner_select" on public.business_day_overrides;
drop policy if exists "business_day_overrides_owner_insert" on public.business_day_overrides;
drop policy if exists "business_day_overrides_owner_update" on public.business_day_overrides;
drop policy if exists "business_day_overrides_owner_delete" on public.business_day_overrides;

create policy "business_day_overrides_owner_select"
  on public.business_day_overrides for select
  to authenticated
  using (public.is_business_owner(business_id));

create policy "business_day_overrides_owner_insert"
  on public.business_day_overrides for insert
  to authenticated
  with check (public.is_business_owner(business_id));

create policy "business_day_overrides_owner_update"
  on public.business_day_overrides for update
  to authenticated
  using (public.is_business_owner(business_id))
  with check (public.is_business_owner(business_id));

create policy "business_day_overrides_owner_delete"
  on public.business_day_overrides for delete
  to authenticated
  using (public.is_business_owner(business_id));

grant select, insert, update, delete on table public.business_day_overrides to authenticated;
