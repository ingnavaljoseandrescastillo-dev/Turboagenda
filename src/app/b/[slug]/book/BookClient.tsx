...
const bookingCopy = {
  ...
  es: {
    ...
    form: {
      ...
      legalConsent: 'He leido y acepto los',
      legalConsentError: 'Debes aceptar los terminos y la politica de privacidad para confirmar.',
  ...
  en: {
    ...
    form: {
      ...
      legalConsent: 'I have read and accept the',
      legalConsentError: 'You must accept the terms and privacy policy to confirm.',
